    ...
    const refresh = Effect.fn("refresh")(function* (provider?: ProviderKind) {
      switch (provider) {
        ...
        case "gemini":
          ...
          break;
        default:
          yield* Effect.all([codexProvider.refresh, claudeProvider.refresh, geminiProvider.refresh], {
            concurrency: "unbounded",
          });
          break;
      }
...
).pipe(Layer.provideMerge(CodexProviderLive), Layer.provideMerge(ClaudeProviderLive), Layer.provideMerge(GeminiProviderLive));
