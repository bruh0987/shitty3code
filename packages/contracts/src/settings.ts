...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    geminiAgent: GeminiSettings.pipe(Schema.withDecodingDefault(() => ({}))),
...
const GeminiModelOptionsPatch = Schema.Struct({
  approvalMode: Schema.optionalKey(GeminiModelOptions.fields.approvalMode),
});
...
const ModelSelectionPatch = Schema.Union([
  ...
  Schema.Struct({
    provider: Schema.optionalKey(Schema.Literal("geminiAgent")),
    model: Schema.optionalKey(TrimmedNonEmptyString),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  providers: Schema.optionalKey(
    Schema.Struct({
      ...
      geminiAgent: Schema.optionalKey(GeminiSettingsPatch),
    }),
  ),
});
